...
CREATE TABLE USERS (
    ...
    CONSTRAINT USERS_PERSON_FK FOREIGN KEY(SSN) REFERENCES PERSON(SSN) ON UPDATE RESTRICT ON DELETE CASCADE,
    CONSTRAINT USERS_FEEDBACK_FK FOREIGN KEY(FEEDBACK_ID) REFERENCES FEEDBACK(FEEDBACK_ID) ON DELETE
...
CREATE TABLE SELLER (
    ...
    CONSTRAINT SELLER_USER_FK FOREIGN KEY(SELLER_SSN) REFERENCES USERS(SSN) ON UPDATE RESTRICT ON DELETE CASCADE
);
...
CREATE TABLE BUYER (
    ...
    CONSTRAINT BUYER_USER_FK FOREIGN KEY(BUYER_SSN) REFERENCES USERS(SSN) ON DELETE CASCADE ON UPDATE RESTRICT
);
...
CREATE TABLE STAFF (
    ...
    CONSTRAINT STAFF_PERSON_FK FOREIGN KEY(SSN) REFERENCES PERSON(SSN) ON UPDATE RESTRICT ON DELETE CASCADE
);
...
CREATE TABLE CASH (
    ...
    CONSTRAINT CASH_PAYMENT_FK FOREIGN KEY (PAYMENT_ID) REFERENCES PAYMENT(PAYMENT_ID) ON DELETE CASCADE ON UPDATE RESTRICT
);
...
CREATE TABLE CREDIT (
    ...
    CONSTRAINT CREDIT_PAYMENT_FK FOREIGN KEY (PAYMENT_ID) REFERENCES PAYMENT(PAYMENT_ID) ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT CREDIT_CARD_NUMBER_CK CHECK(CARD_NUMBER REGEXP '^[0-9]+$')
);
...
CREATE TABLE ORDERS (
    ...
    CONSTRAINT ORDERS_PAYMENT_FK FOREIGN KEY (PAYMENT_ID) REFERENCES Payment(PAYMENT_ID) ON DELETE CASCADE ON UPDATE RESTRICT,
    CONSTRAINT ORDERS_BUYER_FK FOREIGN KEY (SSN) REFERENCES BUYER(BUYER_SSN) ON DELETE CASCADE ON UPDATE RESTRICT,
    CONSTRAINT ORDERS_DELIVERY_FK FOREIGN KEY (SHIPMENT_ID) REFERENCES DELIVERY(SHIPMENT_ID) ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE PRODUCT(
    ...
    CONSTRAINT PRODUCT_CATEGORY_FK FOREIGN KEY(CAT_ID) REFERENCES CATEGORY(CAT_ID) ON DELETE RESTRICT ON UPDATE RESTRICT
);
...
CREATE TABLE STOCK(
    ...
    CONSTRAINT STOCK_PRODUCT_FK FOREIGN KEY (PID) REFERENCES Product(PID) ON DELETE CASCADE ON UPDATE RESTRICT,
    CONSTRAINT STOCK_INVENTORY_FK FOREIGN KEY (INV_ID) REFERENCES Inventory(INV_ID) ON DELETE CASCADE ON UPDATE RESTRICT,
    CONSTRAINT STOCK_PQUANTITY_CK CHECK (P_QUANTITY >= 0)
);
...
CREATE TABLE REQUEST(
    ...
    FOREIGN KEY (INV_ID) REFERENCES INVENTORY(INV_ID) ON DELETE CASCADE ON UPDATE RESTRICT,
...
CREATE TABLE TECHNICAL_SUPPORT(
    ...
    CONSTRAINT TECHNICAL_SUPPORT_STAFF_FK FOREIGN KEY(SSN) REFERENCES STAFF(SSN) ON UPDATE RESTRICT ON DELETE CASCADE
);
...
CREATE TABLE RATE(
    ...
    CONSTRAINT RATE_TECHNICAL_SUPPORT_FK FOREIGN KEY(T_S_SSN) REFERENCES TECHNICAL_SUPPORT(SSN) ON UPDATE RESTRICT ON DELETE CASCADE,
...
CREATE TABLE SELL(
    ...
    CONSTRAINT SELL_SELLER_FK FOREIGN KEY(SSN) REFERENCES SELLER(SELLER_SSN) ON UPDATE RESTRICT ON DELETE RESTRICT,
    CONSTRAINT SELL_PRODUCT_FK FOREIGN KEY(PID) REFERENCES PRODUCT(PID) ON UPDATE RESTRICT ON DELETE RESTRICT
);
...
CREATE TABLE RATING (
    ...
    CONSTRAINT RATING_BUYER_FK FOREIGN KEY(SSN) REFERENCES BUYER(BUYER_SSN) ON UPDATE RESTRICT ON DELETE RESTRICT,
    CONSTRAINT RATING_PRODUCT_FK FOREIGN KEY(PID) REFERENCES PRODUCT(PID) ON UPDATE RESTRICT ON DELETE RESTRICT
);
...
CREATE TABLE ADMIN(
    ...
    CONSTRAINT ADMIN_STAFF_FK FOREIGN KEY(SSN) REFERENCES STAFF(SSN) ON UPDATE RESTRICT ON DELETE CASCADE
);
...
CREATE TABLE MANAGE(
    ...
    CONSTRAINT MANAGE_ADMIN_FK FOREIGN KEY(SSN) REFERENCES ADMIN(SSN) ON UPDATE RESTRICT ON DELETE CASCADE,
    CONSTRAINT MANAGE_PRODUCT_CK FOREIGN KEY(PID) REFERENCES PRODUCT(PID) ON UPDATE RESTRICT ON DELETE CASCADE
);
...
CREATE TABLE INCLUDES(
    ...
    CONSTRAINT INCLUDES_ORDER_FK FOREIGN KEY(ORDER_ID) REFERENCES ORDERS(ORDER_ID) ON UPDATE RESTRICT ON DELETE CASCADE,
    CONSTRAINT INCLUDES_PRODUCT_CK FOREIGN KEY(PID) REFERENCES PRODUCT(PID) ON UPDATE RESTRICT ON DELETE CASCADE
);

-- @block
LOAD DATA LOCAL INFILE './data/INCLUDES.csv'
INTO TABLE INCLUDES
FIELDS TERMINATED BY ','
LINES TERMINATED BY '\n';
